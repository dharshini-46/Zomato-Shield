    ...
    return (
      <div style={{ padding: '20px 20px 100px 20px', background: '#f8f9fa', minHeight: '100vh' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '24px', position: 'relative' }}>
          ...
          <h1 style={{ fontSize: '1.2rem', fontWeight: '800', margin: 0, color: '#111827' }}>How Shield Works</h1>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '40px' }}>
          {[
            { icon: '🧠', title: 'Smart Detection', desc: 'Our AI monitors weather and pollution in your delivery zone in real-time.' },
            { icon: '⚡', title: 'Automatic Trigger', desc: 'If conditions (like rain >50mm) are met, your claim is triggered automatically.' },
            { icon: '💸', title: 'Instant Payout', desc: 'Money is credited to your wallet within minutes—no paperwork needed.' },
            { icon: '🛡️', title: 'Stay Protected', desc: 'Continue working safely knowing your earnings are covered regardless of volume.' }
          ].map((item, i) => (
            <div key={i} style={{ background: '#fff', borderRadius: '32px', padding: '24px', display: 'flex', alignItems: 'flex-start', gap: '16px', boxShadow: '0 4px 15px rgba(0,0,0,0.02)', border: '1px solid #f3f4f6' }}>
              <div style={{ width: '48px', height: '48px', background: '#fff0f1', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.4rem', flexShrink: 0 }}>
                {item.icon}
              </div>
              <div>
  ...
  return (
    <div style={{ padding: '20px 20px 100px 20px', background: '#f8f9fa', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#fff', borderRadius: '32px', padding: '24px', boxShadow: '0 8px 30px rgba(226,55,68,0.05)', border: '1px solid #ffe4e6', marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <h3 style={{ fontSize: '1.4rem', fontWeight: '800', color: '#111827', margin: '0 0 8px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            7-day No-Claim <span style={{ fontSize: '1.4rem' }}>🔥</span>
          </h3>
        ...
        <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: '#fff0f1', border: '4px solid #fecdd3', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.8rem', color: '#e23744' }}>
          🔥
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '16px', overflowX: 'auto', paddingBottom: '16px', margin: '0 -20px', padding: '0 20px', scrollbarWidth: 'none' }}>
        {[
          { icon: '🎖️', title: 'Low Risk Hero' },
          { icon: '⭐', title: 'Safe Performer' },
          { icon: '🛡️', title: 'Shield Vet' }
        ].map((badge, i) => (
          <div key={i} style={{ background: '#fff', borderRadius: '50%', width: '100px', height: '100px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 4px 15px rgba(0,0,0,0.03)', border: '1px solid #f3f4f6', gap: '4px' }}>
            <div style={{ fontSize: '1.6rem', background: '#f8f9fa', width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{badge.icon}</div>
